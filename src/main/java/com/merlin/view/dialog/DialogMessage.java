...
public class DialogMessage {
    ...
    private DialogMessage() {
        mDialog = new DialogCommon.Builder(MContext.app()).setLayout(R.layout.m_dialog_message).center().build();
    ...
    public void show(FragmentManager fragmentManager, int titleId, int messageId, int btnId,
                     final IDialog.OnCancelListener onCancelListener,
                     final IDialog.OnConfirmListener onConfirmListener) {
        show(fragmentManager, MUtil.string(titleId), MUtil.string(messageId), MUtil.string(btnId),
                onCancelListener, onConfirmListener);
    }


    public void show(FragmentManager fragmentManager, String title, String message, String btn,
                     final IDialog.OnCancelListener onCancelListener,
                     final IDialog.OnConfirmListener onConfirmListener) {
